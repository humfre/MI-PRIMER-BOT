...
const app = express().use(bodyParser.json()); // Creates express app and parses incoming requests as JSON

const PAGE_ACCESS_TOKEN = 'TOKEN_DE_META';
const VERIFY_TOKEN = 'TOKEN_DE_VERIFICACIÓN_META';
...
app.get('/webhook', (req, res) => {
  ...
  if (mode && token) {
    ...
    // Verifies the token sent is correct
